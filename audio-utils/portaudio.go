/*
This source code for binding with portaudio was gotten from https://github.com/gordonklaus/portaudio
Thanks to the team of contributors!
*/
...
func PanicIfErrDeferred(f func () error) {
	err := f()
	if err != nil {
		panic(err)
	}
